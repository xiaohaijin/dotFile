...
QtModule {
    ...
    staticLibsRelease: []
    dynamicLibsDebug: []
    dynamicLibsRelease: ["/opt/qt/install/5.10.1/gcc_64/lib/libQt5EventDispatcherSupport.a", "gthread-2.0", "glib-2.0", "/opt/qt/install/5.10.1/gcc_64/lib/libQt5ServiceSupport.a", "/opt/qt/install/5.10.1/gcc_64/lib/libQt5ThemeSupport.a", "/opt/qt/install/5.10.1/gcc_64/lib/libQt5DBus.so.5.10.1", "/opt/qt/install/5.10.1/gcc_64/lib/libQt5FontDatabaseSupport.a", "fontconfig", "freetype", "/opt/qt/install/5.10.1/gcc_64/lib/libQt5FbSupport.a", "/opt/qt/install/5.10.1/gcc_64/lib/libQt5EglSupport.a", "Xext", "X11", "m", "EGL", "/opt/qt/install/5.10.1/gcc_64/lib/libQt5InputSupport.a", "/opt/qt/install/5.10.1/gcc_64/lib/libQt5PlatformCompositorSupport.a", "GL", "/opt/qt/install/5.10.1/gcc_64/lib/libQt5Gui.so.5.10.1", "/opt/qt/install/5.10.1/gcc_64/lib/libQt5DeviceDiscoverySupport.a", "/opt/qt/install/5.10.1/gcc_64/lib/libQt5Core.so.5.10.1", "pthread", "dl"]
    linkerFlagsDebug: []
    linkerFlagsRelease: []
    frameworksDebug: []
    frameworksRelease: []
    ...
    libFilePathDebug: ""
    libFilePathRelease: "/opt/qt/install/5.10.1/gcc_64/lib/libQt5EglFSDeviceIntegration.so.5.10.1"
    cpp.defines: ["QT_EGLFSDEVICEINTEGRATION_LIB"]
    cpp.includePaths: ["/opt/qt/install/5.10.1/gcc_64/include", "/opt/qt/install/5.10.1/gcc_64/include/QtEglFSDeviceIntegration", "/opt/qt/install/5.10.1/gcc_64/include/QtEglFSDeviceIntegration/5.10.1", "/opt/qt/install/5.10.1/gcc_64/include/QtEglFSDeviceIntegration/5.10.1/QtEglFSDeviceIntegration"]
